...
export default function ProjectDetail() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="bg-oxigen-dark text-white pt-28 pb-20 px-6 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-96 h-96 bg-oxigen-light/20 rounded-full blur-2xl -translate-y-1/2 translate-x-1/3" />
                <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-500/10 rounded-full blur-xl translate-y-1/3 -translate-x-1/3" />
